...
const serialProducts = [
  { id: 'p1', title: 'Платформы одноосные', price: 'от 43 000 ₽', image: '/1os.jpg', desc: 'Базовые прицепы для перевозки легких грузов.' },
  { id: 'p2', title: 'Платформы двухосные', price: 'от 75 000 ₽', image: '/2os.jpg', desc: 'Усиленные платформы для тяжелых и габаритных грузов.' },
  { id: 'p3', title: 'Бортовые прицепы', price: 'от 55 000 ₽', image: '/bort.jpg', desc: 'Универсальные прицепы с откидными металлическими бортами.' },
  { id: 'p4', title: 'Коневозки', price: 'от 350 000 ₽', image: '/kon.jpg', desc: 'Специализированные фургоны для безопасной перевозки лошадей.' },
  { id: 'p5', title: 'Рамы', price: 'от 30 000 ₽', image: '/rama.jpg', desc: 'Готовые рамы под ваши индивидуальные проекты надстроек.' },
  { id: 'p6', title: 'Подкаты', price: 'от 85 000 ₽', image: '/eva.jpg', desc: 'Подкатные тележки для частичной погрузки автомобиля.' },
];
...
const processSteps = [
  ...
  { id: '04', icon: Truck, title: 'Отправка', desc: 'Доставка готовой техники в ваш регион' },
    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-20">
        <div className="max-w-3xl">
          ...
          >
            Прицепы • Эвакуаторы • Подкаты • Дома на колесах. Создаем надежную технику премиум-класса с полным циклом 
          ...
          <div className="relative z-10 order-1 lg:order-2 py-8 lg:py-0">
            ...
            >
              ...
              <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: "easeOut" } } }} className="text-gray-600 text-lg lg:text-xl mb-14 font-light leading-relaxed">
                Мы создаем надежную технику под индивидуальные задачи бизнеса. 
...
const ProductCard: React.FC<{ product: any, index: number }> = ({ product, index }) => (
  ...
  >
    ...
    <div className="p-6 md:p-8 flex flex-col flex-grow">
      ...
      <a href="#contact" className="mt-auto inline-flex items-center text-sm font-bold uppercase tracking-widest text-blue-600 group/btn">
      ...
      <div className="container mx-auto px-6 max-w-7xl flex flex-col lg:flex-row gap-16">
        <div className="lg:w-1/2">
          ...
          <p className="text-gray-400 font-light text-lg mb-12">
            ...
            и сроков производства вашей техники.
          </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
          <div>
            ...
            <p className="text-gray-500 text-sm max-w-sm">
              Производство надежных транспортных модулей премиум-класса для бизнеса и путешествий.
            </p>
          </div>
